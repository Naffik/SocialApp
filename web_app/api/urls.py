...
from .views import (PostListView, PostDetailView, PostSearchView, PostCreateView, PostFavAddView, CommentListView,
                    ...
                    PostLikeAddView, UserCommentListView, PostMediaListView, UserPostListView, )
...
urlpatterns = [
    ...
    path(r'post/<str:username>/', UserPostListView.as_view(), name='user-posts-list'),
    path(r'post/<int:pk>/fav/', PostFavAddView.as_view(), name='post-fav-add-remove'),
    path(r'post/<int:pk>/like/', PostLikeAddView.as_view(), name='post-like-add-remove'),
